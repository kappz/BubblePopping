...
public class CannonMode_Controller_Multiplayer : MonoBehaviour, IMultiplayerView
{
    ...
    public TextMeshProUGUI currentOpponentScoreDisplay;
    ...
    public void UpdateScore(int score)
    {
        ...
        playGamesClient.OnScoreUpdate(score);
    ...
    */
    ...
    void endGameCheck(int powder)
    {
        ...
        if (powder <= 0)
        {
            ...
            playGamesClient.OnMultiplayerGameEnd();
        }
    }
    ...
    {
        Debug.Log("(updatePlayerScore) score: " + score);
        currentOpponentScoreDisplay.text = score.ToString();
        playGamesClient.OnScoreUpdate(score);
    }
